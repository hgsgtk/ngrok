...
func (h *Http) WrapConn(c ngrok.Conn, ctx interface{}) ngrok.Conn {
	tee := ngrok.NewTee(c)
...
func (h *Http) readRequests(tee *ngrok.Tee, lastTxn chan *HttpTxn, connCtx interface{}) {
	defer close(lastTxn)
...
func (h *Http) readResponses(tee *ngrok.Tee, lastTxn chan *HttpTxn) {
